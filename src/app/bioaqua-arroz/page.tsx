      ...
      <main className="flex-1 w-full overflow-x-hidden">
        ...
        <section className="bg-white overflow-hidden w-full">
          <div className="px-[5px] pt-[5px] cursor-pointer" onClick={openPopup}>
            <div className="relative w-full overflow-hidden rounded-xl shadow-lg border-2 border-amber-100">
              <img 
                src={bannerTopImg} 
                alt="Bioaqua Kit de Arroz 6 Piezas"
          ...
          <div className="p-5 text-center space-y-4">
            <div className="flex justify-center items-center gap-2">
              <div className="flex gap-0.5">
                {[1,2,3,4,5].map(i => <Star key={i} className="h-6 w-6 fill-amber-500 text-amber-500" />)}
              </div>
              <span className="text-[12px] font-black text-slate-400 uppercase tracking-widest">(+1,200 CLIENTAS FELICES)</span>
            </div>
            ...
            <div className="mt-8 text-left space-y-6">
              <h3 className="text-[22px] font-black text-slate-900 text-center uppercase leading-tight tracking-tight px-4">
                🌾 PIEL RADIANTE CON <br /><span className="text-amber-600 underline decoration-amber-200 decoration-4 underline-offset-4">RICE RAW PULP</span> 🌾
              </h3>
              
              <div className="space-y-4 text-[16px] text-slate-600 font-medium leading-relaxed">
                <p>
                  Descubre el poder del extracto de arroz puro. Este kit completo de 6 piezas está diseñado para transformar tu piel, devolviéndole su brillo natural y suavidad de porcelana.
                </p>
                <p>
                  Incluye: Limpiador, Tónico, Loción, Serum, Crema Facial y Crema de Ojos. Una rutina completa en un solo set.
                </p>
              </div>
                ...
                <div className="grid grid-cols-2 gap-3 px-1">
                  ...
                  >
                    ...
                    <div className="pt-8 space-y-2">
                      ...
                      <p className="text-[12px] font-black text-amber-600 uppercase leading-tight italic">+ REGALO GRATIS</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div className="bg-slate-50 p-6 rounded-2xl border-2 border-dashed border-slate-200 text-center relative overflow-hidden">
                    ...
                    <p className="text-[16px] font-black text-slate-700 uppercase tracking-tight leading-relaxed">
                      🔥 <span className="text-amber-600 italic">OFERTA EXTRA:</span> Agrega cualquier producto de regalo adicional a tu pedido por solo <br />
                      <span className="text-[20px] text-amber-600 underline decoration-amber-200 decoration-4 underline-offset-4">+$8 DÓLARES C/U</span>
                    </p>
                    <Button 
                      onClick={openPopup}
                      size="sm" 
        ...
        <div className="mx-4 bg-slate-900 p-6 rounded-2xl flex items-center gap-4 shadow-lg border-b-4 border-amber-600">
          ...
          <p className="text-[16px] font-black text-white uppercase leading-tight tracking-wide">
            ¡LANZAMIENTO LIMITADO! <br /><span className="text-amber-500">Solo 50 kits disponibles</span>
          </p>
        </div>
          ...
          <div className="container px-4 text-center space-y-8">
            <div className="space-y-3">
              ...
              <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tighter leading-none">
                🎁 REGALO EXTRA <br /><span className="text-amber-600 italic">CON TU PACK DE 2</span>
              </h2>
            </div>

            <div className="grid grid-cols-1 gap-4">
              {GIFTS.map((gift, i) => (
                <div key={i} className="bg-white rounded-2xl p-5 shadow-md border border-amber-50 flex items-center gap-5 relative overflow-hidden pointer-events-none">
        ...
        <section className="py-10 bg-white w-full overflow-hidden text-center space-y-10">
          <div className="container px-4">
            ...
            <div className="space-y-8">
              <h2 className="text-3xl font-black text-slate-900 uppercase tracking-tighter leading-none">
                ¿LISTA PARA TU <br /><span className="text-amber-600 italic underline decoration-amber-200 underline-offset-8">RUTINA DE LUJO?</span>
              </h2>
              <Button 
                onClick={openPopup}
                size="lg" 

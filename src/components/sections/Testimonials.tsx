...
export function Testimonials({ 
  ...
  return (
    <section id="testimonios" className="py-6 bg-white overflow-hidden relative border-t border-slate-100">
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-6 space-y-4">
          ...
          <div className="space-y-1">
            ...
            <p className={`text-[14px] font-black uppercase tracking-widest ${textColor}`}>
              {subtitle}
            </p>
          </div>
        </div>

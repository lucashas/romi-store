        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col items-center gap-1">
            ...
            <p className={cn(
              ...
              isDark ? "text-[#CCCCCC]" : "text-primary/60"
            )}>
          ...
          <div className="grid grid-cols-1 gap-1.5 text-center text-[10px] font-bold">
            <div className="flex items-center justify-center gap-2">
              <MessageSquare className={cn("h-3 w-3", isDark ? "text-[#DAA520]" : "text-primary")} />
              <span className={isDark ? "text-[#CCCCCC]" : "text-slate-600"}>WhatsApp: 0997740583 (Solo Chat)</span>
            </div>
            <div className="flex items-center justify-center gap-2">
              <Mail className={cn("h-3 w-3", isDark ? "text-[#DAA520]" : "text-primary")} />
              <span className={isDark ? "text-[#CCCCCC]" : "text-slate-600"}>Email: orozco.pancho73@hotmail.com</span>
            </div>
            <div className="flex items-center justify-center gap-2">
              <MapPin className={cn("h-3 w-3", isDark ? "text-[#DAA520]" : "text-primary")} />
              <span className={isDark ? "text-[#CCCCCC]" : "text-slate-600"}>Quito, Ecuador - Envíos a todo el país</span>
            </div>
          </div>
          
          {/* Links */}
          <div className="flex flex-wrap justify-center gap-x-4 gap-y-1 text-[9px] font-black uppercase tracking-tighter">
          ...
          <div className="text-center space-y-2 max-w-[400px]">
            <p className={cn("text-[9px] font-medium", isDark ? "text-[#CCCCCC]" : "text-slate-500")}>
              © {year ?? "..."} Romi Store EC. Todos los derechos reservados.
            </p>
            
            <div className={cn("pt-2 space-y-1 border-t", isDark ? "border-zinc-900" : "border-slate-100")}>
              <p className={cn("text-[7px] leading-tight italic uppercase tracking-tighter", isDark ? "text-[#CCCCCC]" : "text-slate-400")}>
